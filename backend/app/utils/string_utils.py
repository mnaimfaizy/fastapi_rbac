...
def format_permission_name(permission_name: str, group_name: Optional[str] = None) -> str:
    ...
    Examples:
        ...
        - Permission: "Test Permission", Group: "Test Group" -> "test.group.test.permission"
    ...
    formatted_permission = permission_name.lower().replace(" ", ".")

    # If group name is provided, format it and prepend to the permission name
    if group_name:
        formatted_group = group_name.lower().replace(" ", ".")
