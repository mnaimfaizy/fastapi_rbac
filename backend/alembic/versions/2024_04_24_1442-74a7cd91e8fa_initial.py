...
def upgrade() -> None:
    ...
    sa.Column('permission_group_id', sqlmodel.sql.sqltypes.GUID(), nullable=True),
    sa.ForeignKeyConstraint(['permission_group_id'], ['PermissionGroup.id'], ),
    ...
    sa.Column('needsToChangePassword', sa.Boolean(), nullable=False),
    ...
    op.create_table('UserPasswordHistory',
